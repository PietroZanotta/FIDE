...
.venv/bin/python -m pytest -q \
  experiments/skyrmions_deep_ritz_full/test_official_b1_pareto.py \
  experiments/skyrmions_deep_ritz_full/test_final_b1_support_confirmation.py \
  experiments/skyrmions_deep_ritz_full/test_single_reference_b1_preflight.py
```
