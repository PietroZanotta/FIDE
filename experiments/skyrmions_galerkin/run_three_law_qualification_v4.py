"""Run the support-robust three-Law refreeze and common-task qualification."""
...
from . import three_law_qualification_v4 as qualification
from .galerkin_only import execution_device


def main() -> None:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--stage", choices=("protocol", "laws", "development", "all"), default="all")
    ...
    with jax.default_device(execution_device()):
        if args.stage == "protocol":
            ...
            result = qualification.refreeze_all_laws(cfg, print)
