...
# Linux often ships the unrelated Tesseract OCR program under the same name.
# Tesseract Core's CLI supports the `build` subcommand; OCR Tesseract does not.
...
exec "${TESSERACT_BIN}" build tesseracts/physical_relaxation
